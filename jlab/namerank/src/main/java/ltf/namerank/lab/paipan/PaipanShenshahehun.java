 ...
 * 神煞合婚法
 */
public class PaipanShenshahehun {
    enum sex {
    ...
    public String shensha(Calendar cal) throws ParseException {
        ...
        System.out.println("此人八字【" + lunar.getYearGanZhi(time) + "】"); //获取生肖 System.out.println("此人的农历生肖【" + lunar.animalsYear() + "】");

        String GanZhi = lunar.getYearGanZhi(time);//取八字
        String month = lunar.getMonth();//取表格中的中国农历月份 //取月份，其实原来表格不很合理，因为没有考虑闰月和节气问题 //正规算八字按节气算，即使闰月也不怕
    ...
    public static void main(String[] args) {
        PaipanShenshahehun my = new PaipanShenshahehun();
        try {
